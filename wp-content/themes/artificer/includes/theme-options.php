...
// General
		...
		$options[] = array( 'name' => __( 'General Typography', 'woothemes' ) ,
			...
			'std' => array( 'size' => '1.6', 'unit' => 'em', 'face' => 'FontSiteSans-Roman', 'style' => '', 'color' => '#3E3E3E' ),
			'type' => 'typography' );
...
$options[] = array( 'name' => "Contact Form Google Maps Coordinates",
					'desc' => 'Enter your Google Map coordinates to display a map on the Contact Form page template and a link to it on the Contact Us widget. You can get these details from <a href="http://itouchmap.com/latlong.html" target="_blank">Google Maps</a>',
